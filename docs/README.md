...
- **Гипрозем** — агрохимия почвы (P, N, K, гумус) + кадастровые контуры
  всех `parcels` каждого хозяйства
...
**Lazy-загрузка спутника:** инспектор открывает досье — видит **все** parcel'ы
фермера с площадью, габаритами и координатами **за < 1 сек** (без единого
SH/CDSE-запроса). Дальше — кнопка «▶ Посмотреть со спутника» на каждом
parcel'е. Только клик дёргает SH/CDSE/HyP3 для этого конкретного участка.
Это экономит квоту и время на больших хозяйствах с десятками парцел.
